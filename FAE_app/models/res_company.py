...
class ResCompanyInherit(models.Model):
    ...
    x_prod_username = fields.Char(string='Usuario prod.', copy=False)
    x_prod_password = fields.Char(string='Clave prod.', copy=False)
    x_prod_pin = fields.Char(string='PIN prod.', copy=False)
    x_prod_crypto_key = fields.Binary(string='LLave Criptográfica prod.', attachment=False, copy=False)
    x_prod_expire_date = fields.Date(string='Fecha Expiración prod', copy=False)
